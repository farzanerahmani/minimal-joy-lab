...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "پت‌کر — سامانه مدیریت کلینیک دامپزشکی" },
      { name: "description", content: "سامانه‌ای مینیمال و کاربردی برای مدیریت بیماران، نسخه‌ها، یادآور واکسن و پیامک کلینیک‌های دامپزشکی." },
    ],
    links: [
